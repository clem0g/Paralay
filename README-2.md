...
- *Example:* "Argentina has the easiest path to the quarterfinals if they get past the brutal R32 vs Uruguay; after that, Colombia/Canada/Belgium are the only obstacles."
...
- *Example:* "I haven't seen enough to be decisive yet. I have about five teams I could believe could lift the cup."
...
A post reasons in football terms but concludes that *no one* can be picked yet, e.g. "It's too early — it could go literally to anyone between these seven teams." **Rule:** if the post ends without committing to a target team, it's `meta_skepticism`, even if the language sounds analytical, because it gives Parlay no team to weight.
